...
v31：176項遊戲／部署測試通過；無限結算不顯示戰線下一場，整備預覽與實際Boss一致。Chrome真鍵鼠驗證暫停、結算、重試、回整備與切換模式後戰線下一場。v30既有驗證：實際Chrome驗證主機自動射擊、僚機獨立目標、護甲吸收、滿狀態補給、推進中段位置、敵人／掩體碰撞、Boss出生與模式切換。受控驗證不等於真人趣味或長局平衡評分。密集場景保留效能改善空間，沒有宣稱所有硬體穩定60FPS。
